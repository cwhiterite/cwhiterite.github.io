...
$null = Format-HTML -Range $ac -List $users -File $index -Date "10/29" -Page 1;
$null = Format-HTML -Range $dj -List $users -File $page2 -Date "10/29" -Page 2;
$null = Format-HTML -Range $ko -List $users -File $page3 -Date "10/29" -Page 3;
$null = Format-HTML -Range $pz -List $users -File $page4 -Date "10/29" -Page 4;
